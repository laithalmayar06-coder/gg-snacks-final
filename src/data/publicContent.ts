...
export const pageCopy = {
  en: {
    ...
    formNote: 'Send your enquiry to GG Snacks. Company and phone are optional.', check: 'CHECK ENQUIRY',
    ...
    contactIntro: 'Use the contact form to send an enquiry to GG Snacks.',
  ...
  ar: {
    ...
    formNote: 'أرسل استفسارك إلى جي جي سناكس. الشركة ورقم الهاتف اختياريان.', check: 'تحقق من الاستفسار',
    ...
    contactIntro: 'استخدم نموذج التواصل لإرسال استفسارك إلى جي جي سناكس.',
